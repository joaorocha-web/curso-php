<nav class="modulos">
            ...
            <div class="modulo laranja">
                ...
                <ul>
                    <li>
                        <a href="exercicio.php?dir=array&file=basico">Introdução</a>
                    </li>   
                    <li>
                    ...
                    <li>
                        <a href="exercicio.php?dir=array&file=multidimensionais">Multidimensionais</a>
                    </li>   
                    <li>
            ...
            <div class="modulo verde">
                ...
                <ul>
                    ...
                    <li>
                        <a href="exercicio.php?dir=tratamento_erro&file=gerenciador_erros">Error Handler</a>
                    </li>   
            ...
            <div class="modulo laranja">
                ...
                <ul>
                    ...
                    <li>
                        <a href="exercicio.php?dir=db&file=inserir_02">Inserir Registros #2</a>
                    </li>  
                    <li>
                        <a href="exercicio.php?dir=db&file=alterar">Alterar Registros #2</a>
                    </li>  
                    <li>
